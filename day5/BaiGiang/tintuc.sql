...
(2, 'Đền thiêng Sefa Utaki ở Okinawa', 'Sefa Utaki nằm ở phía đông nam của đảo Okinawa Honto', 'hinh2.jpg', NULL, '2017-05-16 17:00:00', 1),
...
--
ALTER TABLE `danhmuctin`
  MODIFY `id_danhmuctin` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tintuc`
--
ALTER TABLE `tintuc`
  MODIFY `id_tintuc` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
